...
public class DefaultListableBeanFactory extends AbstractAutowireCapableBeanFactory
    ...
    public void removeRegisterBeanDefinitionListener(RegisterBeanDefinitionListener listener) {
        this.listener = null;
    }

    private void fireBeanRegistered(String beanName, BeanDefinition beanDefinition) {
        if (this.listener != null)
            listener.beanRegistered(beanName, beanDefinition);
    }
    ...
    public void registerBeanDefinition(String beanName, BeanDefinition beanDefinition)
        ...
        if (oldBeanDefinition != null || containsSingleton(beanName)) {
            ...
            fireBeanRegistered(beanName, beanDefinition);
        }
    }
